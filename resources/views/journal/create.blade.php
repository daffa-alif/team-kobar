    ...
    <div class="container mx-auto mt-10 max-w-6xl">
        <h2 class="text-3xl font-semibold text-center text-gray-800 mb-8">Create New Journal</h2>

        <!-- Form -->
        <form action="{{ route('journal.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-8 rounded-lg shadow-lg space-y-6">
            @csrf
